...
const meetingSchema = new mongoose.Schema({
    ...
    meeting_type: { type: String, enum: ['general', 'mid-year-review', 'final-evaluation'], default: 'general' },
    cycle_id: { type: mongoose.Schema.Types.ObjectId, ref: 'Cycle' },
    employee_id: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },
    final_evaluation_id: { type: mongoose.Schema.Types.ObjectId, ref: 'FinalEvaluation' },
